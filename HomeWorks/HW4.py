...
# for _ in range(m):
#     number = int(input())
#     some_list2.append(number)
# some_list3 = []
# for i in some_list1:
#     if i in some_list2 and i not in some_list3:
#             some_list3.append(i)
# some_list3.sort()
# print(some_list3)
...
# n_set = set(randint(1, 20) for i in range(int(input('Введите кол-во: '))))
# print(n_set)
# m_set = set(randint(1, 20) for i in range(int(input('Введите кол-во: '))))
# print(m_set)
